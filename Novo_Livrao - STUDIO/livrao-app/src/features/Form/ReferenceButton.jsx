...
export const ReferenceButton = ({ fieldId, fieldLabel, currentRef, onSave }) => {
    ...
    // Mesmas opções do SourceInfoWidget
    ...
    return (
        <>
            ...
            {/* Formulário Inline (estilo SourceInfoWidget) */}
            {isOpen && (
                <div className="mt-4 bg-white/5 border border-white/10 rounded-lg p-4 animate-fade-in backdrop-blur-sm">
                    ...
                    <div className="space-y-3">
                        {/* Grid de Opções (estilo SourceInfoWidget) */}
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className={`w-5 h-5 rounded flex items-center justify-center border ${isSelected ? 'bg-blue-600 border-blue-600' : 'border-slate-300'
                                            ...
                                            {isSelected && (
                                                <svg className="w-3.5 h-3.5 text-white font-bold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
