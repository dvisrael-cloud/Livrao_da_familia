...
export const PhotoGalleryModal = ({ isOpen, onClose, targetMember, uid }) => {
    ...
    const handleFiles = async (files) => {
        ...
        try {
            ...
            // ❌ LOG: falha no upload da galeria
            logError('PhotoGalleryModal', 'gallery_upload_failed', error, uid);
    ...
    const handleDelete = async (photoToDelete) => {
        ...
        try {
            ...
            // ❌ LOG: falha ao excluir foto da galeria
            logError('PhotoGalleryModal', 'gallery_delete_failed', error, uid, photoToDelete?.name);
    ...
    const handleUpdateCaption = async (photo, newCaption) => {
        try {
            ...
            // ❌ LOG: falha ao editar legenda de foto
            logError('PhotoGalleryModal', 'gallery_caption_update_failed', error, uid, photo?.name);
        }
    };
